...
@property (nonatomic, strong) FadeBlackView        *fadeBlackView;  //黑色背景
@property (nonatomic, strong) UpdatingView         *upDatingView;   //加载动画 雪花loding
...
- (void)viewDidLoad {
    ...
    // loading 加载动画
    self.upDatingView        = [[UpdatingView alloc] initWithFrame:self.view.frame color: [UIColor whiteColor]];
